...
# - Blueprint: chia cấu trúc API thành từng nhóm
# - jsonify: trả dữ liệu JSON về Frontend
# - request: lấy dữ liệu từ Frontend (POST, PUT)

from config import get_sqlserver_connection, get_mysql_connection
# - get_sqlserver_connection(): kết nối SQL Server (HUMAN)
# - get_mysql_connection(): kết nối MySQL (PAYROLL)
